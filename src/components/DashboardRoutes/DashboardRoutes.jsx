    ...
    return (
        <div className="relative border">
            ...
            <div className="text-center">
                <div type="button" className="absolute top-5 right-5 py-2 px-2 border bg-slate-500 text-white text-sm font-medium rounded-full hover:bg-slate-400 active:bg-slate-500 focus:outline-none focus:ring-2 focus:ring-transparent" onClick={toggleSidebar}>
                    {
                        isSidebarOpen ?
