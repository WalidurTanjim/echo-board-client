...
const Accordian = () => {
    return (
        <section className='questions container mx-auto px-6 py-14'>
            <SectionTitle title="Some User Questions" sub_title="Here some questions for our user. Which they want to know" />
