...
const UserFeedback = () => {
    ...
    return (
        <section className='user-feedback container mx-auto px-6 py-14'>
            <SectionTitle title="User Feedback" sub_title="The User Feedback section allows users to share their experiences, suggestions, and issues about the platform." />
                                    ...
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                                                <p>
                                                The forum is smooth and user-friendly! I love the like, comment, and share options, but a search feature for posts would make it even better.
                                                </p>
                                            </blockquote>
                                ...
                                <div className="overflow-hidden">
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                                                <p>
                                                Authentication and authorization work seamlessly. I appreciate the ability to report inappropriate content, but an edit option for comments would be useful.
                                                </p>
                                            </blockquote>
                                            <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-emerald-500">
                                                <span
                                ...
                                <div className="overflow-hidden">
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                                                <p>
                                                Announcements are a great addition! It keeps us updated. However, adding notifications for likes and replies would improve engagement.
                                                </p>
                                            </blockquote>
                                            <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-emerald-500">
                                                <span
